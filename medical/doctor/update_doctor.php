...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="../index.php">Doctor Adjust</a>
        <!-- Sidebar Toggle-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <!-- Update INTO books (doctor_id, doctor_name, doctor_room)
                                            VALUES ("1", "Wittawit", "YoshiRoom"); -->
                                        <?php
                                            $doctor_id = $_GET['doctor_id'];
                                            require_once("../dbConnect.php");
                                            $strQuery = "SELECT * FROM doctor where doctor_id = " . $doctor_id;
                                        ...
                                        <form role="form" action="sql_doctor.php" method="post"
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="id" name="doctor_id" value="<?php echo $data['doctor_id']; ?>"
                                                        placeholder="Enter ID">
                                                </div>

                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Doctor Name</label>
                                                    <input type="text" class="form-control" name="doctor_name" value="<?php echo $data['doctor_name']; ?>"
                                                         placeholder="Enter Name">
                                                </div>

                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Doctor Room</label>
                                                    <input type="text" class="form-control" id="doctor_room"  value="<?php echo $data['doctor_room']; ?>"
                                                        name="doctor_room" placeholder="Enter Room">
